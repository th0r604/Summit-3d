...
interface NavSection {
  label: string;
  minRole: "member" | "club_admin" | "nf_admin" | "if_admin";
  items: NavItem[];
}
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    minRole: "if_admin",
    items: [
      { href: "/federation/countries", label: "Countries" },
      { href: "/federation/events", label: "Global Events" },
      { href: "/federation/officials", label: "Int'l Officials" },
    ],
  },
];
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs text-gray-400 hover:text-white transition ml-3 whitespace-nowrap"
          >
            Sign out
          </button>
        </div>
