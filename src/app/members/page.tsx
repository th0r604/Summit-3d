...
const COLUMNS: Column[] = [
  ...
  { key: "Membership Type", label: "Type" },
...
const FORM_FIELDS: FieldConfig[] = [
  ...
  { name: "Membership Status", label: "Membership Status", type: "select", required: true, options: ["Active", "Expired", "Pending", "Suspended"] },
  { name: "Membership Type", label: "Membership Type", type: "select", required: true, options: ["Athlete", "Coach", "General", "Lifetime"] },
  { name: "Membership Start", label: "Membership Start", type: "date" },
  { name: "Membership Expiry", label: "Membership Expiry", type: "date" },
...
export default function MembersPage() {
  ...
  return (
    <div className="p-8">
      ...
      <Modal open={modalOpen} onClose={() => { setModalOpen(false); setEditing(null); }} title={editing ? "Edit Member" : "Add Member"}>
        <EntityForm
          fields={FORM_FIELDS}
